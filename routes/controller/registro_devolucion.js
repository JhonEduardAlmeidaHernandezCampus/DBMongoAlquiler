...
__decorate([
    ...
    Transform(({ value }) => {
        if (value === undefined || value === null) {
            throw { status: 422, message: `Date_Return is required` };
        }
...
__decorate([
    ...
    Transform(({ value }) => {
        if (value === undefined || value === null) {
            throw { status: 422, message: `Fuel_Return is required` };
        }
...
__decorate([
    ...
    Transform(({ value }) => {
        if (value === undefined || value === null) {
            throw { status: 422, message: `Mileage_Return is required` };
        }
        if (Math.floor(value) && typeof value == "number")
            return Math.floor(value);
        else
...
__decorate([
    ...
    Transform(({ value }) => {
        if (value === undefined || value === null) {
            throw { status: 422, message: `Additional_Amount is required` };
        }
        if (Math.floor(value) && typeof value == "number")
            return Math.floor(value);
        else
